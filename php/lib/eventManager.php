    ...
    class eventManager {
        ...
        public function retriveEvent( $user , $eventId ) {
            ...
            for ( $i = 0 ; $row = $rowFiles->fetch_assoc() ; ++$i ) {
                ...
                $this->event[ $this->lastEventId ][ 'FILE' ][ $i ][ 'MIME' ] = $row[ 'csr_d_mime' ] ;
                $this->event[ $this->lastEventId ][ 'FILE' ][ $i ][ 'NAME' ] = $row[ 'csr_d_name' ] ;
                $this->event[ $this->lastEventId ][ 'FILE' ][ $i ][ 'PATH' ] = $row[ 'csr_d_path' ] ;
            }
         ...
         *      RANGE_EPOCH  - Get a range of events by epoch
         *
