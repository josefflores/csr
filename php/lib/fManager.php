<?php
    ...
    class fManager {
        ...
        private function record( $mime , $timeStamp , $fileName ) {
            ...
            // Create keyPairs
            $keyPairs[ 'csr_d_usr_id' ]   = CURRENT_USER_ID ;
            $keyPairs[ 'csr_d_time' ]     = $timeStamp ;
            $keyPairs[ 'csr_d_src' ]      = CURRENT_WEB_OR_MFA ;
            $keyPairs[ 'csr_d_src_id' ]   = CURRENT_SRC_ID ;
            $keyPairs[ 'csr_d_mime' ]     = $mime ;
            $keyPairs[ 'csr_d_path' ]     = CURRENT_USER_ID .'\\' ;
            $keyPairs[ 'csr_d_name' ]     = $fileName ;
